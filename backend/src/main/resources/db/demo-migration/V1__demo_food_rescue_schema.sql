...
create table food_listings (
    ...
    pickup_window_starts_at timestamp with time zone,
    pickup_window_ends_at timestamp with time zone not null,
...
create table listing_alert_preferences (
    listing_alert_preference_id uuid primary key,
    listing_id uuid not null references food_listings (listing_id) on delete cascade,
...
select
    ...
    formatdatetime(coalesce(picked_up_at, delivered_at, food_listings.created_at), 'MMM') as month_label,
    cast(count(*) as integer) as donation_count
from food_listings
left join pickup_claims using (listing_id)
where food_listings.status in ('PICKED_UP', 'CLAIMED', 'AVAILABLE')
group by donor_organization_id, formatdatetime(coalesce(picked_up_at, delivered_at, food_listings.created_at), 'MMM')
...
select
    ...
    organizations.name,
    cast(count(*) as integer) as pickup_count
from pickup_claims
...
values
    ('40000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', 'Pasta Primavera & Marinara', 'Prepared meals', 'Packed pans of pasta with marinara sauce.', '48 portions', 48, 'Use loading dock B and ask for Maya.', timestamp with time zone '2026-05-16 18:00:00-07', timestamp with time zone '2026-05-16 19:00:00-07', 'PICKED_UP', 'URGENT', '0.4 mi', 47.609720, -122.333090, 21, 34, '30000000-0000-0000-0000-000000000002', timestamp with time zone '2026-05-16 16:55:00-07'),
    ('40000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000002', 'Bakery Assortment', 'Bakery', 'Mixed breads, pastries, and muffins from end-of-day stock.', '30+ items', 30, 'Pickup from front counter after close.', timestamp with time zone '2026-05-15 19:00:00-07', timestamp with time zone '2026-05-15 20:20:00-07', 'PICKED_UP', 'SOON', '0.7 mi', 47.610120, -122.341010, 72, 31, null, timestamp with time zone '2026-05-15 17:30:00-07'),
    ('40000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000003', 'Fresh Salad Bowls', 'Produce', 'Prepared salad bowls with dressing packed separately.', '22 bowls', 22, 'Refrigerated case by the east entrance.', timestamp with time zone '2026-05-13 17:30:00-07', timestamp with time zone '2026-05-13 19:15:00-07', 'PICKED_UP', 'SOON', '1.1 mi', 47.603830, -122.330060, 45, 56, null, timestamp with time zone '2026-05-13 15:40:00-07'),
    ('40000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000004', 'Bento Boxes & Rice', 'Prepared meals', 'Boxed meals with rice, vegetables, and sauces.', '18 boxes', 18, 'Ask for Hana near the kitchen entrance.', timestamp with time zone '2026-05-10 18:00:00-07', timestamp with time zone '2026-05-10 20:30:00-07', 'PICKED_UP', 'CALM', '1.4 mi', 47.599950, -122.326200, 86, 58, null, timestamp with time zone '2026-05-10 16:25:00-07');
...
values
    ('50000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001', 'DELIVERED', timestamp with time zone '2026-05-16 17:10:00-07', timestamp with time zone '2026-05-16 18:18:00-07', timestamp with time zone '2026-05-16 18:42:00-07'),
    ('50000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000001', 'DELIVERED', timestamp with time zone '2026-05-15 18:00:00-07', timestamp with time zone '2026-05-15 19:08:00-07', timestamp with time zone '2026-05-15 19:35:00-07'),
    ('50000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000003', '30000000-0000-0000-0000-000000000001', 'DELIVERED', timestamp with time zone '2026-05-13 16:35:00-07', timestamp with time zone '2026-05-13 17:55:00-07', timestamp with time zone '2026-05-13 18:24:00-07'),
    ('50000000-0000-0000-0000-000000000004', '40000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000004', '30000000-0000-0000-0000-000000000001', 'DELIVERED', timestamp with time zone '2026-05-10 17:15:00-07', timestamp with time zone '2026-05-10 18:36:00-07', timestamp with time zone '2026-05-10 19:03:00-07');

insert into listing_alert_preferences (listing_alert_preference_id, listing_id, audience, enabled)
values
    ('60000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000001', 'NEARBY_SHELTERS', true),
    ('60000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000001', 'VOLUNTEER_DRIVERS', true),
    ('60000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000001', 'FOODBANKS', false),
    ('60000000-0000-0000-0000-000000000004', '40000000-0000-0000-0000-000000000002', 'NEARBY_SHELTERS', true),
    ('60000000-0000-0000-0000-000000000005', '40000000-0000-0000-0000-000000000002', 'VOLUNTEER_DRIVERS', true),
    ('60000000-0000-0000-0000-000000000006', '40000000-0000-0000-0000-000000000002', 'FOODBANKS', false),
    ('60000000-0000-0000-0000-000000000007', '40000000-0000-0000-0000-000000000003', 'NEARBY_SHELTERS', true),
    ('60000000-0000-0000-0000-000000000008', '40000000-0000-0000-0000-000000000003', 'VOLUNTEER_DRIVERS', true),
    ('60000000-0000-0000-0000-000000000009', '40000000-0000-0000-0000-000000000003', 'FOODBANKS', false),
    ('60000000-0000-0000-0000-000000000010', '40000000-0000-0000-0000-000000000004', 'NEARBY_SHELTERS', true),
    ('60000000-0000-0000-0000-000000000011', '40000000-0000-0000-0000-000000000004', 'VOLUNTEER_DRIVERS', true),
    ('60000000-0000-0000-0000-000000000012', '40000000-0000-0000-0000-000000000004', 'FOODBANKS', false);
